...
workflow token under the *system* scope. Counters can be defined by the MapReduce framework or applications.
...
These counters can be retrieved from the workflow token by using a key composed of class name of the
...
These counters can be retrieved from the workflow token by using a key composed of explicitly provided
